...
public class MobileSecurePayHelper
{
	...
	public boolean  detectMobile_sp(final Context context)
	{
		mcontext = context;
		...
		if( !isMobile_spExist )
		{
			...
			mProgress = BaseHelper.showProgress(context, null, "正在检测安全支付服务版本", 
						false, true);
	...
	public static JSONObject sendCheckNewUpdate(String versionName)
	{
	...
	public static JSONObject SendRequest(final String content)
	{
	...
	// 
	// 动态下载
	public static boolean retrieveApkFromNet(Context context, String strurl, String filename)
	{
		boolean bRet = false;		
